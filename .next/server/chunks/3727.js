...
})(["width:", ";height:", ";background-color:", ";border:none;display:flex;justify-content:center;column-gap:20px;align-items:center;cursor:pointer;&:hover{box-shadow:", ";}label{cursor:pointer;font-weight:bold;font-size:var(--fs-14);line-height:21px;text-transform:capitalize;letter-spacing:", ";color:", ";}svg{path{fill:", ";}}box-shadow:inset 0 0 0 0 #e5b100ff;-webkit-transition:ease-out 0.4s;-moz-transition:ease-out 0.4s;transition:ease-out 0.4s;&:hover{box-shadow:inset 240px 0 0 0 #e5b100ff;label{color:", ";}svg{path{fill:", ";}}}"], ({
  width
}) => `${width}px`, ({
  height
}) => `${height}px`, ({
  backgroundColor
}) => backgroundColor ? `${backgroundColor}` : theme_get_default()("colors.yellow"), theme_get_default()("boxShadow.hover"), theme_get_default()("letterSpacing.span"), ({
  textColor
