...
})(["padding:87px 0 99px 0;max-width:1006px;margin:0 auto;@media only screen and (max-width:", "){padding:87px 25px 99px;max-width:100%;}@media only screen and (max-width:", "){padding:60px 25px 40px;}@media only screen and (max-width:", "){padding:40px 15px 20px;}"], theme_get_default()("breakpoints.tabletPro"), theme_get_default()("breakpoints.tablet"), theme_get_default()("breakpoints.mobile"));
...
})(["font-style:normal;font-weight:800;font-size:var(--fs-64);line-height:96px;@media only screen and (max-width:", "){font-size:var(--fs-36);line-height:50px;z-index:1;}@media only screen and (max-width:", "){font-size:var(--fs-28);line-height:39px;}letter-spacing:0.05em;text-transform:capitalize;"], theme_get_default()('breakpoints.tablet'), theme_get_default()('breakpoints.mobile'));
...
})(["position:absolute;top:", ";right:-47px;@media only screen and (max-width:", "){right:-207px;}@media only screen and (max-width:", "){display:block;transform:scale(0.5);right:-160px;top:0;}@media only screen and (max-width:", "){right:-200px;}"], ({
  isWhite
}) => isWhite ? "70px" : "-239px", theme_get_default()("breakpoints.tablet"), theme_get_default()("breakpoints.mobile"), theme_get_default()("breakpoints.mMobile"));
