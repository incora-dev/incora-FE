...
})(["overflow:hidden;background-color:", ";"], theme_get_default()("colors.black"));
const Wrapper = external_styled_components_default().div.withConfig({
  displayName: "Header404style__Wrapper",
  componentId: "sc-1c34sxm-1"
})(["max-width:1006px;margin:0 auto;padding:181px 0 237px;"]);
...
})(["position:relative;right:-11px;display:flex;flex-direction:column;row-gap:68px;"]);
...
})(["width:max-content;position:relative;z-index:1;font-style:normal;font-weight:bold;font-size:var(--fs-16);line-height:30px;letter-spacing:0.1em;color:", ";span{cursor:pointer;}&:before{position:absolute;bottom:7px;right:-6px;width:79px;height:10px;z-index:-1;content:'';background-color:", ";}&:after{position:absolute;bottom:7px;right:-6px;z-index:-1;width:0;height:10px;content:'';background-color:", ";transition:width ", ";}&:hover:after{width:79px;}"], theme_get_default()("colors.white"), theme_get_default()("colors.yellow"), theme_get_default()("colors.yellow5"), theme_get_default()("transition.button"));
