...
// EXTERNAL MODULE: ./services/context/mainMenu.tsx
var mainMenu = __webpack_require__(1426);
...
})(["position:fixed;z-index:10;bottom:0;display:", ";background-color:#fff;a{position:relative;@media only screen and (max-width:1024px){font-weight:600;display:inline-block;padding-left:0;}@media only screen and (max-width:481px){font-weight:600;padding-left:7px;}&:after{position:absolute;bottom:5px;right:-8px;z-index:-1;content:'';height:7px;width:94px;background-color:#FEC602;@media only screen and (max-width:481px){bottom:2px;right:0;width:82px;}}}}"], ({
  shouldShowNotice
}) => shouldShowNotice ? 'none' : 'block');
const Wrapper = external_styled_components_default().div.withConfig({
  displayName: "Noticestyle__Wrapper",
  componentId: "sc-1vk01zv-1"
})(["width:100vw;padding:16.5px 0;@media only screen and (max-width:912px){padding:10px 25px;}@media only screen and (max-width:481px){padding:5px 15px;}"]);
...
})(["margin:auto;width:max-content;display:flex;align-items:center;justify-content:center;column-gap:37px;color:#18181A;@media only screen and (max-width:912px){width:100%;}@media only screen and (max-width:481px){display:block;width:100%;}"]);
const H3 = external_styled_components_default().h3.withConfig({
  displayName: "Noticestyle__H3",
  componentId: "sc-1vk01zv-3"
})(["font-style:normal;font-weight:normal;font-size:var(--fs-16);line-height:24px;letter-spacing:0.05em;color:#18181A;@media only screen and (max-width:481px){font-size:var(--fs-14);}"]);
const Button = external_styled_components_default().div.withConfig({
  displayName: "Noticestyle__Button",
  componentId: "sc-1vk01zv-4"
})(["padding:23px 61.5px;font-style:normal;font-weight:bold;font-size:var(--fs-14);line-height:21px;text-align:center;letter-spacing:0.03em;text-transform:capitalize;cursor:pointer;color:#fff;background-color:#18181A;@media only screen and (max-width:481px){padding:8px 61.5px;margin-top:3px;}"]);
    ...
    children: /*#__PURE__*/jsx_runtime_.jsx(Wrapper, {
      children: /*#__PURE__*/(0,jsx_runtime_.jsxs)(TextBlock, {
        children: [/*#__PURE__*/(0,jsx_runtime_.jsxs)(H3, {
          children: ["This site uses cookies to improve your user experience.", /*#__PURE__*/jsx_runtime_.jsx(next_link["default"], {
            href: '/privacy_policy',
...
var client = __webpack_require__(6557);
...
function MyApp({
  ...
  return /*#__PURE__*/(0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
    ...
    }), /*#__PURE__*/jsx_runtime_.jsx(PrivacyPolicyPage_Notice, {})]
  });
}
...
var __webpack_exports__ = __webpack_require__.X(0, [9400,1664,8040,6557], () => (__webpack_exec__(8827)));
