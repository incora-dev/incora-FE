...
const companyInfo: ICompanyInfo[] = [
  {
    title: "About Us",
    text: "We are a talented software development company that helps business build, launch, and grow outstanding software products.",
    Icon: AboutUsIcon,
    href: "/company/about",
  },
  {
    title: "Careers",
    text: "We welcome proficient talents, who strive to do more and be more. Join the team of diligent minds!",
    Icon: CareersIcon,
    href: "/company/career",
  },
];
...
const CompanyHoverElement = forwardRef(
  ({ titleColor, backgroundColor }: ICompanyHoverElement, ref) => {
    ...
    return (
      ...
      >
        ...
        >
          <PositionLoader>
            <Loader width="181.74" height="181" viewBox="0 0 54 54" />
          </PositionLoader>
